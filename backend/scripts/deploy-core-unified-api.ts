...
/**
 * Deploy Core Unified API Stack (Minimal)
 * 
 * This script deploys only the essential components needed for the unified API
 * without the problematic security enhancements stack.
 */
...
async function deployCore() {
  console.log('🚀 Starting Core Unified API deployment (minimal)...');
  ...
  try {
    ...
    console.log('\n🔧 To deploy, run:');
    console.log('  npm run deploy-core-unified-api');
    console.log('\n📝 After deployment, get configuration values with:');
