  ...
  const quickActions: QuickAction[] = [
    {
      ...
      question: 'What is diabetes and what are the different types?',
      isPrimary: true,
    },
    {
      icon: (
      ...
      question: 'What should my blood sugar levels be and how do I monitor them?',
      isPrimary: true,
    },
    {
      icon: (
    ...
    },
    {
      ...
      question: 'What foods should I eat and avoid if I have diabetes?',
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      label: 'Exercise Tips',
      question: 'How does exercise affect diabetes and what activities are recommended?',
    },
    {
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      label: 'Prevention',
      question: 'How can I prevent diabetes or reduce my risk?',
    },
  ];
    ...
    <div className="flex flex-col items-center w-full max-w-[800px] mx-auto px-4" style={{ gap: '16px' }}>
      ...
      <div className="bg-white rounded-2xl shadow-lg border border-gray-100 w-full" style={{ padding: '24px 24px' }}>
        ...
        <h1 className="text-2xl font-semibold text-center text-gray-900" style={{ marginBottom: '16px' }}>
          Welcome to ADA Clara!
        </h1>
        <p className="text-gray-600 text-center text-sm leading-relaxed m-0">
          Hi, I'm Clara, your diabetes information assistant! I'm here to help you 
          understand diabetes using trusted resources from the American Diabetes Association. 
          Whether you have questions about symptoms, management, nutrition, or prevention, 
      ...
      <div className="bg-gradient-to-r from-[rgba(225,113,0,0.08)] to-[rgba(225,113,0,0.05)] border border-[rgba(225,113,0,0.2)] rounded-xl w-full" style={{ padding: '16px 20px' }}>
        <div className="flex items-start gap-3">
          ...
          <div>
            <h3 className="text-[#e17100] text-sm font-semibold mb-1">Important Medical Information</h3>
            <p className="text-xs text-gray-600 leading-relaxed m-0">
              Clara provides general information only and does not offer medical advice, diagnosis, or treatment. 
              Always consult your healthcare provider for medical decisions. In emergencies, call <strong>911</strong>.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
          {quickActions.map((action, index) => (
            ...
            >
              <span className={action.isPrimary ? 'text-white/90' : 'text-[#a6192e]'}>
                {action.icon}
              </span>
